...
class OpenAIProvider(Provider):
    ...
    def post_init_check(self) -> None:
        try:
            ...
            raise errors.CumulusLibraryError(f"NLP server is unreachable: {exc}")
...
class VllmProvider(OpenAIProvider):
    ...
    def post_init_check(self) -> None:
        try:
            ...
            if False:  # FIXME: exc.code == errors.SERVICE_MISSING:
                raise errors.CumulusLibraryError(  # add a little suggestion
...
class Llama4ScoutModel(Model):
    ...
    COMPOSE_ID = "llama4-scout"  # TODO MIKE: add
