...
mock_manifests = {
    "valid": {
        "study_prefix": "valid",
        "file_config": {"file_names": ["test1.sql", "test2.sql"]},
    ...
    "invalid_only_prefix": {
        "study_prefix": "invalid_only_prefix",
    },
    ...
    "invalid_bad_table_names": {
        "study_prefix": "valid",
        "file_config": {"file_names": ["test1.sql", "Robert'); DROP TABLE Students;--"]},
        "export_config": {"export_list": ["wrong__table1", "wrong__table2"]},
    },
    "invalid_none": "",
}
