        ...
        [
            {
                ...
                "effectiveDateTime": conftest.timestamp_to_epoch(2019, 12, 11, 10, 10, 10, 5),
...
def test_core_diag_report_period(tmp_path):
    ...
    assert effective_fields == {
        ...
        "effectiveDateTime_month": None,
        "effectiveDateTime_year": None,
        "effectivePeriod_start": conftest.timestamp_to_epoch(2023, 10, 6, 9, 30, 0, 0),
        ...
        "effectivePeriod_end": conftest.timestamp_to_epoch(2023, 10, 6, 10, 30, 0, 0),
